...
4. **Update `docs/_source/output_report.md`** — add or update the relevant section to
   reflect what was built: component table in §1, test count in §3.1, or a new feature
   entry in the appropriate phase section. The output report must stay current with every
   merged issue — do not skip this step.

5. **Close the issue with a comment** — post a closing comment on the GitHub issue
   that includes:
